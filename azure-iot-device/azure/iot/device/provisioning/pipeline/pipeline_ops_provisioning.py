...
class SetX509SecurityClient(PipelineOperation):
    """
    ...
    SetX509SecurityClient operation.
    ...
    def __init__(self, security_client, callback=None):
        ...
        has completed or failed.
        """
        super(SetX509SecurityClient, self).__init__(callback=callback)
        self.security_client = security_client


class SetSecurityClientArgs(PipelineOperation):
    """
    A PipelineOperation object which contains connection arguments which were retrieved from a
    symmetric key or a X509 security client likely by a pipeline stage which handles the
    SetSymmetricKeySecurityClient or SetX509SecurityClient operation.
    ...
    def __init__(self, provisioning_host, registration_id, id_scope, callback=None):
        """
        Initializer for SetSecurityClientArgs.
        ...
        """
        super(SetSecurityClientArgs, self).__init__(callback=callback)
