...
class TestConnect(object):
    ...
    def test_configures_tls_context_with_client_provided_certificate_chain(self, mocker, mock_mqtt_client, provider):
        mock_ssl_context_constructor = mocker.patch.object(ssl, "SSLContext")
        mock_ssl_context = mock_ssl_context_constructor.return_value
        ...
        assert mock_ssl_context.load_cert_chain.call_args == mocker.call(fake_client_cert.certificate, fake_client_cert.key, fake_client_cert.pass_phrase)
