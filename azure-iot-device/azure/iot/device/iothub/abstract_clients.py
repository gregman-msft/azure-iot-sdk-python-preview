...
class AbstractIoTHubClient(object):
    ...
    @classmethod
    def create_from_x509_certificate(cls, hostname, x509, device_id, module_id=None):
        """
        ...
        :param module_id : The ID of the module to uniquely identify a module on a device on the OpTHub
