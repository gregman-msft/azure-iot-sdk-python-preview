...
from azure.iot.device.provisioning.x509_provisioning_device_client import (
...
different_clients = [
    {
        "client_class": SymmetricKeyProvisioningDeviceClient,
        "patch_string": "azure.iot.device.provisioning.sk_provisioning_device_client.PollingMachine",
    },
    {
        "client_class": X509ProvisioningDeviceClient,
        "patch_string": "azure.iot.device.provisioning.x509_provisioning_device_client.PollingMachine",
    },
]
